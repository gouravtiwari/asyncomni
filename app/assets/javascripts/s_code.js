...
// s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,ppt"
...
// s.visitorNamespace="visiornamespace"

/* Application specific code starts here */

// function track_custom_links(link_obj, category, link_name) {
//         var s=s_gi(s_account);
//         s.linkTrackVars="prop1,prop6,prop7,prop8";
//         // s.linkTrackEvents='None';
//         // s.tl(link_obj, 'o', link_name);
// }

// function trackDownload(name, obj){
//     trakSpecialLink(name, obj, 'd', "event1");
// }

// function trackHtmlMailToLink(name, obj) {
//     trakSpecialLink(name, obj, 'o', "event2");    
// }

// function trackExit(name, obj){
//     trakSpecialLink(name, obj, 'e', "event1");
// }

// function trackCustomLink(name, obj) {    
//     trakSpecialLink(name, obj, 'o', "event1");
// }
